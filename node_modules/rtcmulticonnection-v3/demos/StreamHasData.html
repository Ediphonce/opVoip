...
<head>
    ...
    <title>Check if StreamHasData using RTCMultiConnection-v3</title>

    <meta name="description" content="Check if StreamHasData ::: Many-to-Many Video Conferencing using RTCMultiConnection v3" />
...
<body>
    <article>
        ...
        <header style="text-align: center;">
            <h1>Check if StreamHasData using RTCMultiConnection-v3</h1>
            <p>
