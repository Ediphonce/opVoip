...
<head>
    ...
    <title>Admin/Guest demo using RTCMultiConnection-v3</title>

    <meta name="description" content="Admin/Guest demo using RTCMultiConnection v3" />
...
<body>
    <article>
        ...
        <header style="text-align: center;">
            <h1>Admin/Guest demo using RTCMultiConnection-v3</h1>
            <p>
        ...
        <script>
            ...
            document.getElementById('btn-become-admin').onclick = function() {
                ...
                connection.checkPresence(connection.adminId, function(isAdminOnline, adminId, adminInfo) {
                    ...
                    connection.open(connection.adminId);
            ...
            var roomid = '';
            if(localStorage.getItem('rmc-admin-id')) {
                roomid = localStorage.getItem('rmc-admin-id');
            }
            else {
                roomid = connection.token();
            }
            document.getElementById('admin-id').value = roomid;
            document.getElementById('admin-id').onkeyup = function() {
                localStorage.setItem('rmc-admin-id', this.value);
            };
