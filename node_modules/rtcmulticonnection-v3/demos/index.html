...
<head>
    ...
    <title>RTCMultiConnection-v3 Demos</title>
...
<body>
    <article>
        ...
        <header style="text-align: center;">
            <h1><a href="https://github.com/muaz-khan/RTCMultiConnection">RTCMultiConnection-v3</a>  Demos / <a href="https://rtcmulticonnection.herokuapp.com/">LIVE Demos</a></h1>
            <p>
        ...
        <section class="experiment" id="demos">
            <h2>
                <a href="#demos">RTCMultiConnection-v3 Demos</a>
            ...
            <ol>
                ...
                <li>
                    <a href="/demos/Scalable-Screen-Broadcast.html">Scalable Screen Broadcast over Unlimited users!</a>
                </li>

                <li>
                    <a href="/demos/admin-guest.html">Admin/Guest demo</a>
                </li>
                ...
                <li>
                    <a href="/demos/Audio+ScreenSharing.html">TwoWay Audio & TwoWay Screen Sharing</a>
                </li>
                ...
                <li>
                    <a href="/demos/Cross-Domain-Screen-Capturing.html">Capture & Share Screen from any domain!</a>
                </li>
                ...
                <li>
                    <a href="/demos/change-resolutions.html">Change Video Resolutions in your Live Sessions</a>
                </li>
                ...
                <li>
                    <a href="/demos/StreamHasData.html">Check if StreamHasData</a>
                </li>
        ...
        <section class="experiment" id="install">
            <h2>
                <a href="#install">How to install v3?</a>
            </h2>
            <pre>
...
node server.js
            ...
            <h2 style="display:block;text-align:center;margin: 5px 15px;"><a href="https://github.com/muaz-khan/RTCMultiConnection#api">RTCMultiConnection v3 API Documentation</a></h2>
        </section>
